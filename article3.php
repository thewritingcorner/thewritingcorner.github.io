...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-container w3-center w3-padding-48 w3-white">
    ...
    <a class="mylink" style="text-decoration-line: none; text-align: center;" href="#begin">
    <h6> Writing in the <span class="w3-tag">Digital Age</span></h6>
    </a>
  </header>
  ...
  <div id="begin" class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        <div class="w3-center">
          <h3>Writing in the Digital Age</h3>
          <h5>Kadian Forrest, <span class="w3-opacity">May 8, 2021</span></h5>
        </div>

        <div class="w3-justify">
            <div>
          <img src="images/kadian.jpg" alt="image of Kadian Forrest" style="width:10%" class="avatar-image w3-padding-16">
            </div>
            <h6>
              <strong>Second Draft: Writing in the Digital Age</strong>
            </h6>
            <div> 
                <iframe src="https://drive.google.com/file/d/1razmZxcFAlfK1s4FxOv2UswuqFQk6Uf7/preview" width="640" height="480"></iframe>
            </div> 
          ...
          <div style="display:none;" class="w3-row w3-margin-bottom w3-center w3-show" id="demo1" >
            <hr>
            <iframe width="100%" height="1300px" src="https://docs.google.com/document/d/e/2PACX-1vQTnV2dCluVTnMyM5QsguZtdb9qy0KmAXUreiEpgxSyZlvyq1Uxq_2Qm7iuN9TAew/pub?embedded=true"></iframe>
          </div>
        </div>
      </div>
      <hr>
